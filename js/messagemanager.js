...
function showMessage(winner){
    ...
    if(winner == 1){
        StringTwitter = "<a class='tweet' target='blank' href='http://facebook.com/share?text=se me hizo imposible ganar este juegos genarogg.ml/juegos/Tres-en-raya'>compartir por Facebook</a>";
    }

    else{
        StringTwitter = "<a class='tweet' target='blank' href='http://facebook.com/share?text=he ganado ha un juego con inteligencia artificial genarogg.ml/juegos/Tres-en-raya'>compartir por Facebook</a>";
